# Changelog, 2026-09-14 to 2026-09-21 (archive)

Moved verbatim from `changelog.md` on 2026-09-22 (Session 00 of `docs/ROADMAP.md`),
because the live file had reached 2,584 lines against the ledger rule's ~500-line
trigger. Entries are newest first, exactly as they stood under `Unreleased`.
Earlier history: `changelog-through-2026-09-14.md`. Grep this file; do not read it whole.
