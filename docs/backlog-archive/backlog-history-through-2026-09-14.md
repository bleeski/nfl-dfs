# Backlog history through 2026-09-14 (archive)

Moved verbatim from `backlog.md` on 2026-09-15 so that the live backlog holds only the current queue. Nothing here is deleted or edited; headings keep their original levels. Status lines inside completed briefs describe the state at the time they were written; `backlog.md` is authoritative for current status. Grep this file for a ruling (R16 to R24), a tranche (S0 to S10, W1 to W13, DL1 to DL8) or a dated close-out rather than reading it whole.
...
Status: `DONE`, merged to `main` on 2026-09-14 in commit
`4313455fcd8fd722b699a799dbe19dff19c1be68` (PR #13; source commit `7edddee`,
based on `f2890a6c587b01cede2e07bdcbb3ec1dd0ab0d33`). Q1B adds `scripts/file_standings.py`,
...
Status: `DONE`, merged to `main` on 2026-09-14 in commit
`4313455fcd8fd722b699a799dbe19dff19c1be68` (PR #13; source commit `7edddee`,
based on `f2890a6c587b01cede2e07bdcbb3ec1dd0ab0d33`). Q1C adds `src/nfl_dfs/prelock_manifest.py` and emits
...
Status: `DONE`, merged to `main` in commit
`9036198` (PR #11; source commit `4830330`, based on
`9d25ad75f6fd08a22b700e3062b7304158e5c0c8`).
...
Status: `DONE`, merged to `main` in commit
`f2890a6` (PR #12; source commit `aca0177`, based on
`90361980959916333cbd4b820680166a7e4fe6a2`). The final focused regression passed `203 passed, 1 skipped`
