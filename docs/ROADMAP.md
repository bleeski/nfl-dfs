...
2026-09-24). Session 12 is the next startable row; Sessions 13 and 14 are
...
| 2026-09-24 | Session 11c | Pending to In Progress | claim commit | Claim pushed on `claude/kind-feynman-1r3mwd` |
