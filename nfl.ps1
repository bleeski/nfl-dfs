...
param(
    ...
    [ValidateSet('setup','run','cowork-run','priors-propose','priors-freeze','project','select','review-export','doctor','status','intake','workbook','validate','certify','build','late-swap','settle','learn','audit','preflight','test')]
    [string]$Command = 'run',
